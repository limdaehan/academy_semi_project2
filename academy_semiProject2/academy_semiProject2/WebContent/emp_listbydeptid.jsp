		    ...
		    <div id="area2">
				  ...
				  <div class="collapse navbar-collapse" id="navbarSupportedContent15">
				    ...
				    <ul class="navbar-nav mr-auto">
				      ...
				      <li class="nav-item">
				        <a class="nav-link" href="lname_search.jsp">사원명으로 조회</a>
				      </li>
				      <li class="nav-item">
		   ...
		   <div class="panel">
		    <div id="area1">
		  		<div class="table-wrapper-scroll-y my-custom-scrollbar">
						<%
							String deptID = request.getParameter("deptinput");
						%>
						<%
							String sql = "Select employee_id, first_name, last_name, salary, hire_date, department_id from employees where department_id ="+ deptID;
                      ...
                      <thead>
                        <tr>
                          <th scope="col" ><kbd>EMP_ID</kbd></th>
                          <th scope="col"><kbd>FNAME</kbd></th>
                          <th scope="col"><kbd>LNAME</kbd></th>
                          <th scope="col"><kbd>SAL</kbd></th>
                          <th scope="col"><kbd>HDATE</kbd></th>
                          <th scope="col"><kbd>DEPT_ID</kbd></th>
                        </tr>
                      </thead>
                      <tbody>
