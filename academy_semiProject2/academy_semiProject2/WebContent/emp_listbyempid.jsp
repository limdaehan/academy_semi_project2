				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent-7">
						<ul class="navbar-nav mr-auto">
							<li class="nav-item active"><a class="nav-link" onclick="location.href='homepage.jsp'">Home
		   ...
		   <div class="panel">
		    <div id="area1">
		  		<div class="table-wrapper-scroll-y my-custom-scrollbar">
						<%
							String empids = request.getParameter("empidinput");
						%>
						<%
							String sql = "Select employee_id, first_name, last_name, salary, hire_date, department_id from employees where employee_id ="+ empids;
