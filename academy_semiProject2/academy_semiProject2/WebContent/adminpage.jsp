...
<!DOCTYPE html>
	...
	<body id="body">
		...
		String admins = (String)session.getAttribute("admin");
	 ...
	 <div>
		...
		<div class="row">
		    ...
		    <div id="area2">
				  ...
				  <div class="collapse navbar-collapse" id="navbarSupportedContent15">
				    ...
				    <ul class="navbar-nav mr-auto">
				      ...
				      <li class="nav-item">
				        <a class="nav-link" href="empid_search.jsp">사번 정보조회</a>
				      </li>		
				      <li class="nav-item">
				        <a class="nav-link" href="deptid_search.jsp">부서번호 정보조회</a>
				      </li>	
				      <li class="nav-item">
				        <a class="nav-link" href="lname_search.jsp">사원이름 정보조회</a>
				      </li>		      
				    </ul>
				   <!-- Links -->				
				</div>
		  ...
		  <div class="view overlay">
		    <img class="card-img-top" src="image/adminpage.png" alt="Card image cap">
		  </div>
		  ...
		  <div class="card-body">
		    ...
		    <!-- Title -->
		    <h4 class="card-title">관리자 페이지 입니다.</h4>
		    <!-- Text -->
		    <p class="card-text">This page is for administrator. You can fix employee's data.</p>
		    <!-- Button -->
		    <div>	  
				<button type="button" class="btn btn-secondary" onclick="location.href='editemp.jsp'">사원정보 수정</button>
				<button type="button" class="btn btn-success" onclick="location.href='notyet.jsp'">조회페이지 회원정보 수정</button>
				<button type="button" class="btn btn-dark" onclick="location.href='homepage.jsp'">메인페이지로</button>
			</div>							  
		   <!-- Card -->
 			  </div>
		    </div>		   
