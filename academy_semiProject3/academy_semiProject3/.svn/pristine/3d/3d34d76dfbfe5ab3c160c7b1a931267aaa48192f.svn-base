...
<%@ page language="java" contentType="text/html; charset=utf-8" errorPage="loginErrorPage.jsp"
    pageEncoding="utf-8"%>
<!DOCTYPE html>
<html lang="utf-8">
  ...
  <header>
    ...
    <section class="text-center  view intro-4"
      ...
      <div class="mask rgba-indigo-light">
        ...
        <div class="container h-100 d-flex justify-content-center align-items-center wow fadeIn">
          <!-- Grid column -->
            ...
            <div class="card card-image">
              ...
              <div
                ...
                <div  class="card-body">
                  ...
                  <h1 id="con_gongju" class="font-weight-bold mt-2">비밀번호 찾기</h1>
                  
                  <form action="showPw.do" method="post" onsubmit="return checkEmpty();">

                  
                  <div class="card-body mx-4">
	                      <div class="md-form font-weight-bold text-white mt-2 brown-lighter-hover">
	                          <input type="text"  id="mobile" class="form-control" name="mobile">
                            <label for="mobile">전화번호를 입력해주세요</label>
	                      </div>
	                      <div class="md-form font-weight-bold text-white mt-2 brown-lighter-hover">
	                          <input type="text" id="accountNumber" class="form-control" name="accountNumber">
                            <label for="accountNumber">계좌번호를 입력해주세요 </label>
	                      </div>
                       </form>
                    <!--Grid row-->
                    <div class="row d-flex align-items-center  mb-3 mt-4">
                      ...
                      <div class="col-md-12">
                        <div class="text-center row flex-center">
                            <input type="submit" class="btn pink-gradient btn-rounded btn-lg font-weight-bold" value="비밀번호 찾기">
                            <form><button type="submit" class="btn btn-white btn-rounded btn-lg orange-text font-weight-bold ml-lg-0" onclick="javascript: form.action='cancel.do';">취소</button></form>
                        </div>
                      </div>
                      <!--Grid column-->
