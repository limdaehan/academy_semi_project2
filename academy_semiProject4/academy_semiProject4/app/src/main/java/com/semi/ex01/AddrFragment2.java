...
public class AddrFragment2 extends DialogFragment {
...
//        setStyle(DialogFragment.STYLE_NO_FRAME, android.R.style.Theme_);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup rootView2 = (ViewGroup) inflater.inflate(R.layout.fragment_addr_fragment2, container, false);
        ...
        public void setAddress(final String arg1, final String arg2, final String arg3) {
            handler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    result = ((RegisterActivity) getActivity()).findViewById(R.id.et_ad);
