...
public class LocationInfo extends AppCompatActivity {
    ...
    String getXmlData(){
        ...
        String str1= edit.getText().toString();//EditText에 작성된 Text얻어오기
        String search = URLEncoder.encode(str1);//한글의 경우 인식이 안되기에 utf-8 방식으로 encoding     //지역 검색 위한 변수
